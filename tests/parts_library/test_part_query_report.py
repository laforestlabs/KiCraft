...
_EVENTS = [
    ...
    {
        "tool": "lookup_footprint",
        "outcome": "hit",
        "query": "ams1117-3v3:SOT-223",
        "lib": "ams1117-3v3",
    },
    {"tool": "lookup_footprint", "outcome": "hit", "query": "Device:R", "lib": "Device"},
    {
        "tool": "add_part_from_lcsc",
        "outcome": "fetched",
        "lcsc": "C2913201",
        "library_name": "esp32-s3-wroom-1b",
        "into": "home",
        "maturity": "prototype",
    },
    {
...
def test_summarize_buckets():
    ...
    assert s["vendoring_priority"] == [{"lcsc": "C13298", "misses": 1}]
