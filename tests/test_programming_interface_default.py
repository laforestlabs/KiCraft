...
USB, no bridge); fall back to an onboard CH340N USB-UART bridge only for the classic
...
def test_architecture_spec_decides_programming_interface_early():
    ...
    # CH340N is the fallback only for the classic ESP32 (no native USB).
    assert "ch340n" in low
