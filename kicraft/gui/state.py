...
PLACEMENT_PARAMS: list[dict[str, Any]] = [
    ...
    {"key": "subcircuit_margin_mm", "label": "Subcircuit margin (mm)", "default": 1.5, "min": 0.5, "max": 3.0, "step": 0.1, "group": "Board Geometry", "description": "Extra space around leaf subcircuit bounding box"},
