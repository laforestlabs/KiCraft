...
PLACEMENT_PARAMS: list[dict[str, Any]] = [
    ...
    {"key": "max_placement_iterations", "label": "Max iterations", "default": 3332, "min": 829, "max": 4551, "step": 50, "group": "Placement Physics", "description": "Total force-directed placement iterations"},
    ...
    {"key": "subcircuit_margin_mm", "label": "Subcircuit margin (mm)", "default": 10.82, "min": 6.97, "max": 13.38, "step": 0.1, "group": "Board Geometry", "description": "Extra space around leaf subcircuit bounding box"},
    ...
    # -- Component Behavior --
    {"key": "tht_backside_min_area_mm2", "label": "THT backside threshold (mm2)", "default": 130.0, "min": 80.0, "max": 176.0, "step": 5.0, "group": "Component Behavior", "description": "THT parts above this area placed on back copper layer"},
    ...
    {"key": "sa_refine_rotation_probability", "label": "SA rotation probability", "default": 0.44, "min": 0.05, "max": 0.85, "step": 0.05, "group": "SA Refinement", "description": "Chance of rotating a component during SA"},
    # -- Routing --
    ...
    {"key": "freerouting_max_passes", "label": "FreeRouting max passes", "default": 20, "min": 8, "max": 40, "step": 1, "group": "Routing", "description": "Parent autorouter passes; more = better routing, more time (searched)"},
    {"key": "leaf_freerouting_max_passes", "label": "Leaf FreeRouting passes", "default": 12, "min": 6, "max": 30, "step": 1, "group": "Routing", "description": "Autorouter passes for leaf subcircuits; more = better routing, more time (searched)"},
    {"key": "signal_escape_length_mm", "label": "Signal escape length (mm)", "default": 1.5, "min": 0.5, "max": 3.0, "step": 0.1, "group": "Routing", "description": "Length of pre-routed radial escape stubs from dense connector signal pads (searched)"},
