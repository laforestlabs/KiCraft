...
def _solve_leaf_subcircuit(
    ...
    # debug.json + round_NNNN_* snapshots before a new invocation
    # begins. To keep round_index monotonic across parent rounds (so
    # snapshot filenames don't collide), we offset this invocation's
...
def _persist_solution(
    ...
    # in experiment_runner._purge_prior_run_artifacts, which wipes prior
    # debug.json before a new invocation begins.
